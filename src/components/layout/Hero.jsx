...
const Hero = () => {
  return (
    <section id="home" className="flex bg-primary w-screen h-screen justify-center relative">
      <div
        className="flex flex-col justify-center text-textColor lg:items-start items-center"
        data-aos="fade-in"
      >
        ...
        <div className="lg:absolute lg:-left-64 lg:transform lg:rotate-90 lg:border lg:py-3 lg:px-4 lg:rounded-full border-accent lg:shadow-md lg:shadow-accent md:mt-10 lg:mt-0">
          <Socials />
        </div>
